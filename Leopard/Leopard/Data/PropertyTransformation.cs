...
namespace Leopard.Data
{
    ...
    /// 欄位對應的表示類別。
    /// </summary>
    public class PropertyTransformation : IPropertyTransformation
    {
        ...
        /// <returns></returns>
        public static IPropertyTransformation Create<TEntity>(Expression<Func<TEntity, object>> property, Func<string, object> transformation = null)
        {
            return new PropertyTransformation()
            {
